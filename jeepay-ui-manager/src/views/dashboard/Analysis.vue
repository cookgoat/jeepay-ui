<template>
  <div id="chart-card">
    <div class="chart-top">
      ...
      <div class="chart-item top-right" v-if="$access('ENT_RESELLER_ORDER_OVERALL_VIEW')">
        <div class="chart-data user-greet">
          <h4>京东E卡</h4>
          <a-form layout="inline" class="table-head-ground">
            <div class="table-layer">
              <jeepay-text-up :placeholder="'核销商号'" :msg="jdResellerNo" v-model="jdResellerNo" style="margin-top: 4px" />
              ...
              <span class="table-page-search-submitButtons" style="margin-left: 20px;margin-top: 4px">
                ...
                <a-button style="margin-left: 8px" icon="reload" @click="() => this.jdResellerNo = ''">重置</a-button>
              </span>
            </div>
          </a-form>
          <JeepayTable
      ...
      <div class="chart-item top-right" v-if="$access('ENT_RESELLER_ORDER_OVERALL_VIEW')">
        <div class="chart-data user-greet">
          ...
          <a-form layout="inline" class="table-head-ground">
            <div class="table-layer">
              <jeepay-text-up :placeholder="'核销商号'" :msg="ctripResellerNo" v-model="ctripResellerNo" style="margin-top: 4px" />
              <a-form-item label="" style="max-width:350px;min-width:300px">
                <a-range-picker
              ...
              <span style="margin-left: 20px;margin-top: 4px">
                <a-button type="primary" icon="search" @click="queryCtripFunc" :loading="btnLoading">搜索</a-button>
                <a-button style="margin-left: 8px" icon="reload" @click="() => this.ctripResellerNo = ''">重置</a-button>
              </span>
            </div>
          </a-form>
          <JeepayTable
...
import JeepayTable from '@/components/JeepayTable/JeepayTableNoPage'
...
import {
  ...
  getPayCount,
  getPayType,
  jdoverallResellerCount,
  xcoverallResellerCount
} from '@/api/manage'
...
export default {
  ...
  components: { empty, JeepayTable, JeepayTextUp },
  methods: {
    init () {
      const that = this
    ...
    xc_reqTableDataFunc: function (params) {
      params = {
        ...
        resellerNo: this.ctripResellerNo
      }
