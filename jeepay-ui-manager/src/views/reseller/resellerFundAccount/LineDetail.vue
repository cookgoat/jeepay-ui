                ...
                <a-col :span="6">
                    <a-descriptions>
                        <a-descriptions-item label="变更前回款金额">
                            {{ '￥'+detailData.beforeRecoveriesAmount  / 100}}
                        </a-descriptions-item>
                    </a-descriptions>
                </a-col>
                ...
                <a-col :span="6">
                    <a-descriptions>
                        <a-descriptions-item label="变更金额">
                            {{ '￥'+detailData.changeRecoveriesAmount  / 100}}
                        </a-descriptions-item>
                    </a-descriptions>
                </a-col>
                ...
                <a-col :span="6">
                    <a-descriptions>
                        <a-descriptions-item label="变更后回款金额">
                            {{ '￥'+detailData.afterRecoveriesAmount  / 100}}
                        </a-descriptions-item>
                    </a-descriptions>
                </a-col>
            </a-row>
                ...
                <a-col :span="10">
                    <a-descriptions>
                        <a-descriptions-item label="手续费">
                            {{ '￥'+detailData.resellerShareAmount / 100 }}
                        </a-descriptions-item>
                    </a-descriptions>
                </a-col>
